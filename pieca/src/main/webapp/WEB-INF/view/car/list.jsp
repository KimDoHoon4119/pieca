	...
	if (userid == '') {
		...
		$.ajax({
			...
			success:function(result){
				...
				liketotal(carno)
				$("#car_list_like_ok"+carno).css("transform", "scale(1.8)");
				$("#car_list_like_ok"+carno).css("transition", "transform 1s ease-in-out");
				setTimeout(function() {
					$("#car_list_like_ok"+carno).css("transform", "scale(1)");
				}, 1000);
			}
		});
	}
