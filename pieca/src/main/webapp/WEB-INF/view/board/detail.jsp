	...
	<table class="w3-table">
		...
		<tr>
			<td colspan="2"><a href="reply?num=${board.num}">[답변]</a> <a
				...
				href="list?boardid=${board.boardid}">[게시물목록]</a> <c:if
	...
	<form:form modelAttribute="comment" action="comment" method="post"
		...
		<div class="w3-row">
			<div class="w3-col s2  w3-center">
				<p>
					<form:input path="writer" class="w3-input w3-border"
						placeholder="작성자" />
					...
					<td class="w3-right">
						<form action="commdel" method="post" name="commdel${stat.index}">
							<input type="hidden" name="num" value="${c.num}"> <input
								type="hidden" name="seq" value="${c.seq}"> <input
								type="password" name="pass" placeholder="비밀번호"> <a
								class="w3-btn w3-border w3-blue"
